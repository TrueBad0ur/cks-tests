...
BLOCKED_PATTERNS = os.environ.get("BLOCKED_PATTERNS", "danger,malware,untrusted").split(",")
...
class ImagePolicyHandler(BaseHTTPRequestHandler):
    def do_POST(self):
        ...
        reason = f"blocked images: {blocked}" if blocked else "all images allowed"
        print(f"images={images} allowed={allowed} reason={reason}")
